...
namespace LudumDare41.Entities.Behavior
{
    ...
    public class SquidwardAttackBehavior : EntityBehavior 
    {
        private readonly Universe universe;

        public SquidwardAttackBehavior(Universe universe) 
        {
            this.universe = universe;
        }
    ...
    public class MrManderAttackBehavior : EntityBehavior 
    {
        private Universe universe;
        public MrManderAttackBehavior(Universe universe) 
        {
            this.universe = universe;
        }
    ...
    public abstract class EnemyAttackBehavior : EntityBehavior
    {
        ...
        protected abstract void Combat(Enemy enemy);
